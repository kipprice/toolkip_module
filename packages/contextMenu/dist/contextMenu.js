 ...
 * ----------------------------------------------------------------------------
 */
class ContextMenu extends toolkip_drawable_1._Drawable {
    //#endregion
    //..........................................
    /**
     * ContextMenu
     ...
     *
     */
    constructor(target, noStyles, colors) {
        ...
        this._options = new toolkip_data_structures_1.Collection();
     ...
     */
    addOption(opt, subOptions, parent) {
        ...
        if (!opt.elems.base) {
            ...
            opt.elems.base = toolkip_create_elements_1.createSimpleElement("", "ctxOption", opt.label, null, null, parent);
     ...
     */
    addSubOption(srcOption, subOption) {
     ...
     */
    _buildSubMenu(srcOption) {
        srcOption.elems.sub_menu = toolkip_create_elements_1.createSimpleElement("", "subMenu hidden", "", null, null, srcOption.elems.base);
    ...
    _getOption(lbl) {
        ...
        let iCol = this._options.getElement(lbl);
     ...
     */
    _setThemeColors() {
        toolkip_object_helpers_1.map(this._colors, (color, uniqueId) => {
            // TODO: convert over
