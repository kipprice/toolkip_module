...
import { isNullOrUndefined, IPoint } from '@kipprice/toolkip-shared";
...
import { clientRectToBasicRect } from '@kipprice/toolkip-maths/rectConversion";
import { measureElement } from '@kipprice/toolkip-htmlHelpers/elementPositioning";
...
export class Tooltip extends _Drawable {
    ...
    protected _positionAppropriately(): void {
        ...
        this._tooltipRect = clientRectToBasicRect(measureElement(this._elems.base));
        this._sourceRect = clientRectToBasicRect(measureElement(this._sourceElement));
