...
import { IBasicRect, IExtrema } from '@kipprice/toolkip-maths/_interfaces";
...
import { reconcileOptions } from '@kipprice/toolkip-objectHelpers/combine";
...
import { makeDraggable }  from '@kipprice/toolkip-draggable/draggableWrapper";
