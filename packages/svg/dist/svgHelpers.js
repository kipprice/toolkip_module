...
function createSVG(def) {
    try {
        ...
        if (!def.attr.viewbox) {
            def.attr.viewbox = "0 0 0 0";
        }
        if (!def.attr.preserveAspectRatio) {
            def.attr.preserveAspectRatio = "xMinYMin meet";
        }
        return toolkip_create_elements_1.createSVGElement(def);
    }
    catch (e) {
...
exports.createSVGElem = createSVGElem;
;
