...
import { ErrorPopup } from "@toolkip/popups";
...
export abstract class _GoogleLoginButton extends _Drawable {
    ...
    protected _createElements(): void {
        ...
        this._elems.base = createElement({ id: "elgoog", cls: "g-signin2" });
    ...
    private _onSignInFailure(): void {
        let errorPopup = new ErrorPopup("We couldn't log you in securely. Are you supposed to be here?");
