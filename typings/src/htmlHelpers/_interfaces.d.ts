...
export declare type IChildren = IChild[];
export declare type IChild = StandardElement | IElemDefinition | Drawable;
...
export declare type IKeyedElems = IDictionary<StandardElement | Drawable>;
/**
 * IElemDefinition
 * ----------------------------------------------------------------------------
